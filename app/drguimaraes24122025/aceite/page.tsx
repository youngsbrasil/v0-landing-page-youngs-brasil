  ...
  return (
    <div className="min-h-screen bg-[#39FF14] flex items-center justify-center p-6">
      ...
      >
        ...
        >
          Parabéns por dar este passo rumo ao lançamento de Parto Sem Medo!
        </motion.p>
        ...
        >
          <p className="text-lg font-bold">
            Em breve, nossa equipe entrará em contato para dar início ao projeto Dr. Guimarães 24122025.
          </p>
        </motion.div>
